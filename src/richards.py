# from https://github.com/Dundee/pybenchmarks
...
#
# 2020-11-28 pyxdroid, modified a little bit for using it in chkvalid
...
#        return -1
#    print(iterations, "iterations finished in:", endTime - startTime, 'secs')
#    return 42
